        ...
        <div className="rounded-xl bg-surface2 px-4 py-3.5">
          {next ? <>
            <div className="flex items-center justify-between gap-2 text-[13px]">
              <p className="font-semibold">다음 · {next.name} 암벽화</p>
            ...
            <progress aria-label={`${next.name} 암벽화까지 성취 점수`} value={Math.min(result!.points, next.points)} max={next.points}
            ...
            <p className="mt-1 text-[11px] text-muted">점수와 완등 조건을 모두 채우면 승급</p>
          </> : <>
