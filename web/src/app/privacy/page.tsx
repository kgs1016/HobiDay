  ...
  return (
    <main className="mx-auto max-w-2xl px-5 pb-16">
      ...
      <S title="2. 수집하는 개인정보와 목적">
        ...
        <p>
          <b className="text-ink">프로필(모임 서비스 제공):</b> 닉네임, 성별, 나이, 활동
          지역(동네), 프로필 사진, 취미 활동 실력·경력(구력), 주 활동 장소, 키(선택), MBTI(선택),
          자기소개(선택). 나이·실력은 모임 조건 확인에 사용됩니다.
        </p>
        <p>
          <b className="text-ink">서비스 이용 과정에서 생성:</b> 모임 개설·신청 내역,
          채팅 신청·모임 참여 내역, 채팅 메시지, 게시판·영상에 올린 글·영상과 댓글,
        ...
        <p>
          <b className="text-ink">프로필 작성 흐름 개선:</b> 내부 회원 식별번호,
          기본정보·클라이밍화 설정 화면 진입과 저장 시도·완료·오류 발생 시각,
          이용 환경(웹·iOS·Android), 앱 버전, 오류 유형을 기록합니다.
          작성 중인 입력 내용이나 오류 메시지 원문은 이 기록에 포함하지 않으며,
          운영자만 가입 과정의 불편과 장애를 확인하는 데 사용합니다.
        </p>
      </S>

      <S title="3. 보유 기간과 파기">
        <p>프로필 작성 흐름 기록은 90일이 지난 뒤 매일 정리하며, 그 전에 탈퇴하면 함께 삭제합니다.</p>
        <p>
          개인정보는 <b className="text-ink">회원 탈퇴 시 지체 없이 파기</b>합니다. 탈퇴하면
          프로필·사진·영상·채팅·모임 참여 내역이 삭제됩니다. 다음은 예외입니다.
        </p>
        <p>
      ...
      <S title="6. 이용자의 권리">
        <p>
          이용자는 언제든지 앱에서 프로필을 열람·수정할 수 있고, 회원 탈퇴(내 프로필 → 내 정보 →
